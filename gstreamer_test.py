...
<<<<<<< HEAD
    ...
    if ( eyebox_h//2 + ipd ) <= camera_B_h//2 :
    ...
    # left image
    camera_A = frame[ split_len : , : ]#left image
    ...
    if ( eyebox_h//2 + ipd ) <= camera_A_w//2 :
...
#-----------------------------------------Modes------------------------------------------------
    ...
    #-----------------------------------------Post-Processing--------------------------------------    fill_A = np.zeros([camera_A_h, camera_A_w, 3], dtype = np.uint8)
